...
images = []
races=[]
for file in files:#이미지에서 인종을 판별하는 문자열 저장
...
model = Model(inputs=inputs, outputs=[race_model]) 
...
#model 저장
model.save('UTKface_race_model.h5')
...
hist_csv_file = 'race_history.csv'
