...
for file in files:#이미지에서 나이, 성별을 판별하는 문자열 저장
...
#model compile
model.compile(optimizer = 'adam', loss =['mse','binary_crossentropy'],metrics=['mae','accuracy', precision, recall])
...
#model 저장
model.save('UTKface_age_gender_model.h5')
...
hist_csv_file = 'age_gender_history.csv'
